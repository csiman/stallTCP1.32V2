...
// 用户配置区域（用 ""+""  拆分）
const UUID = "4453e945-3d7b-4857-85dc-f5684fe51c68"; // 可用的uuid
const WP = "Songbill";  // 登录密码
const SUB_PWD = "1101";  // 订阅密码
let PIP = 'Pro'+'xy.jp.'+'93'+'0318.xyz';  // 自定义的中转ip
let SUB = 'sub.'+'cm'+'lius'+'sss.net';  // 自定义的订阅源
